                    ...
                    <form action="./Process/manageDeviceController.php?function=updatemode&&deviceid=<?php echo $row['id'] ?>" class="de-mode text-input" method="POST">
                      <div class="btn-table">
                        ...
                        <?php if ($row["device_mode"] == 0) { ?>
                          <input type="submit" name="btn_enroll" id="btn_enroll" value="Enrollment" class="btn-enroll" style="background-color: blue; font-weight:bold;">
                        ...
                        <?php } else { ?>
                          ...
                          <input type="submit" name="btn_attendance" id="btn_attendance" value="Attendance" class="btn-attendence" style="background-color: blue; font-weight:bold;">
