...
<div class="login-wrapper">
    <form class="login-form" action="../Process/login.php" method="post">
        ...
        <div class="login-item">
            <input style="font-size:15px;" type="email" id="email-login" name="email-login" class="login-input email" placeholder="✉️ Email">
            <span class="alert-error"></span>
            <span class="alert"></span>
        </div>
        <div class="login-item">
            <input style="font-size:15px;"type="password" id="password" name="password" class="login-input" placeholder="🔑 Password">
            <span class="alert-error"></span>
        </div>
        <div>
